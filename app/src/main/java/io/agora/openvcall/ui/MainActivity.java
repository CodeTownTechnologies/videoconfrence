...
public class MainActivity extends BaseActivity implements RoomsAdapter.Listener {
    ...
    protected void initUIandEvent() {
        ...
        ((TextView) findViewById(R.id.ovc_page_title)).setTextSize(12);


        EditText v_channel = (EditText) findViewById(R.id.etChannelName);
    ...
    public void showActivationDialog() {
        ...
        btnActivate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (code.isEmpty()) {
                    Toast.makeText(MainActivity.this, getString(R.string.code_required),
